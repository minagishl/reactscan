...
- Build output now minified via esbuild (see scripts/build.mjs).
- Cleaned up ESLint configuration formatting.

### Fixed

- Corrected documentation date typo.
...
[unreleased]: https://github.com/minagishl/reactscan/compare/v1.2.3...HEAD
[1.2.3]: https://github.com/minagishl/reactscan/compare/v1.2.2...v1.2.3
